...
def standardize_product(product_name):
    ...
    if "credit card" in product_name_lower:
        ...
        "savings account" in product_name_lower
        or "saving account" in product_name_lower
    ):
        return "Savings account"
    elif (
        "money transfer" in product_name_lower or "wire transfer" in product_name_lower
    ):
